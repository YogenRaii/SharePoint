                ...
                <form name="form" role="form" ng-submit="sendMessage()">
                    ...
                    <div class="row control-group">
                        <div
                            ...
                            <p ng-cloak class="help-block text-danger"
                    ...
                    <div class="row control-group">
                        <div
                            ...
                            <p ng-cloak class="help-block text-danger"
                               ng-show="submitted && form.phone.$error.required">
                                Please enter your phone number.</p>
                            <p ng-cloak class="help-block text-danger"
                               ng-show="submitted && ((form.phone.$error.minlength || form.phone.$error.maxlength) && form.phone.$dirty)">
                    ...
                    <div class="row control-group">
                        <div
                            ...
                            <p ng-cloak class="help-block text-danger"
                               ng-show="submitted && form.message.$error.required">
