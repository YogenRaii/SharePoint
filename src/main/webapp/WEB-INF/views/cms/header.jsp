...
<header class="header dark-bg">
    ...
    <!--logo start-->
    <a href="${pageContext.servletContext.contextPath}/cms/loginsuccess" class="logo">Now<span
            class="lite">Start Java</span></a>
    <!--logo end-->
        ...
        <ul class="nav pull-right top-menu">
            ...
            <li class="dropdown"><a data-toggle="dropdown"
                ...
                <ul class="dropdown-menu extended logout">
                    ...
                    <li><a href="<c:url value="logout" />"><i class="icon_key_alt"></i>
                        Log Out</a></li>
                </ul>
            </li>
